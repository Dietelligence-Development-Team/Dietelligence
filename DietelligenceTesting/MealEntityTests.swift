...
final class MealEntityTests: XCTestCase {
    ...
    func testDietaryAdvice_WithValidData_DecodesCorrectly() {
        // ARRANGE
        let recommendedDish = Dietelligence.RecommendedMealDish(
        ...
        let mockAdvice = Dietelligence.DietaryAdviceResult(
            analysis: Dietelligence.NutritionAnalysis(
                summary: "Good balance",
                nutritionStatus: "Healthy",
                pros: ["High protein"],
                cons: ["Low fiber"]
            ),
            nextMealRecommendation: Dietelligence.NextMealRecommendation(
